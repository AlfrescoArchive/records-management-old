...
/**
 * NOOP implementation so that the WebDrone Grid could be used
 * 
 * @author Roy Wetherall
 */
public class POProperties implements WebDroneProperties
{
    @Override
    ...
    @Override
    public <T extends Version> T getVersion()
    {
        return null;
    }
}
