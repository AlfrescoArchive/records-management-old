...
public abstract class ClassificationDialog extends Dialog
{
    ...
    public List<String> getAvailableLevels()
    {
        ...
        List<WebElement> levels = retry(() -> getLevelsMenu().findElements(By.cssSelector(selector)), 5);
   ...
   /**
     ...
     * Set downgrade event
     */
    public ClassificationDialog setDowngradeEvent(String event)
    {
        selectTab(DOWNGRADE_SCHEDULE);
     ...
     */
    public ClassificationDialog setDeclassificationEvent(String event)
    {
        selectTab(DECLASSIFICATION_SCHEDULE);
     ...
     */
    public ClassificationDialog removeSelectedReason(String id) throws NoSuchElementException
    {
     ...
     */
    public ClassificationDialog removeSelectedExemption(String index) throws NoSuchElementException
    {
        selectTab(DECLASSIFICATION_SCHEDULE);
