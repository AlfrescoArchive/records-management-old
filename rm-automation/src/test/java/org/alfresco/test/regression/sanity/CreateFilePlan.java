...
public class CreateFilePlan extends BaseTest
{
    ...
    public void createFilePlan()
    {
        ...
        openPage(userDashboardPage)
            ...
            .setSiteURL(SANITY_COLLAB_SITE_ID)
    ...
    protected void deleteCollaborationSite()
    {
        ...
        if (mySites.siteExists(SANITY_COLLAB_SITE_ID))
        {
            // delete site
            mySites.clickOnDeleteSite(SANITY_COLLAB_SITE_ID);
            assertFalse(mySites.siteExists(SANITY_COLLAB_SITE_ID));
    ...
    private void declareInplaceRecord()
    {
        ...
        openPage(userDashboardPage)
           .getMySitesDashlet()
           .clickOnCollaborationSite(SANITY_COLLAB_SITE_ID);
