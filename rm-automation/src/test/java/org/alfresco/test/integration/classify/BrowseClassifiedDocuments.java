...
public class BrowseClassifiedDocuments extends BaseTest
{
    ...
    @Test
    (
        groups = { "integration" }, // TODO Can un-ignore when we have fixed issue with changing user in UI tests. We also need to get feature working before test will pass.
